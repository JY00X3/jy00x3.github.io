...
tags: [windows, active-directory, adcs, assumed-breach, easy, cve-2025-24071]
image:
...
Add the machine to your local hosts file:

```bash
echo "10.129.31.61 fluffy.htb dc01.fluffy.htb" | sudo tee -a /etc/hosts
...
```bash
10.129.31.61  fluffy.htb dc01.fluffy.htb
Initial Access
