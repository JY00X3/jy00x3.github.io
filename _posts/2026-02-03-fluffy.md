...
date: 2026-02-04 18:00:00 +0000
categories: [HACK THE BOX]
tags: [walkthrough, windows, active directory, easy, cve-2025-24071, adcs]
image:
...
* **Attack Vector:** SMB Write + NTLM Leak + ADCS ESC16

**Fluffy** is a Windows Active Directory machine that demonstrates an **Assumed Breach** scenario. The compromise path involves weaponizing a writable SMB share using **CVE-2025–24071** to leak NTLM hashes, followed by chaining AD ACL misconfigurations and **ADCS (ESC16)** to achieve full domain compromise.
